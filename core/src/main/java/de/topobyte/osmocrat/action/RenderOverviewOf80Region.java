...
public class RenderOverviewOf80Region extends OsmocratAction
{

	private static final long serialVersionUID = 1L;

	public RenderOverviewOf80Region(OsmocratMainUI osmocrat)
	{
		super(osmocrat, "Render Overview of 80% Area",
				"Render a map showing the 80% region");
	...
	{
		BBox bbox = osmocrat.get80PercentArea();
